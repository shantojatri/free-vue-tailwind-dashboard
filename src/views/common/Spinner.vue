...
<template>
  <MainLayout>
    <!-- Breadcrumb -->
    <Breadcrumb :items="['Home', 'Common', 'Spinner']" />
    ...
    <div class="card p-8 mb-10">
      <div class="mb-4">
        ...
        <p class="text-sm font-regular text-gray-500 dark:text-gray-400">
          Example of a color variant Spinner
        </p>
      </div>
      <div class="space-x-2">
        <div
        ...
        <div
          class="animate-spin inline-block size-6 border-[3px] border-current border-t-transparent text-red-600 rounded-full"
          role="status"
          aria-label="loading"
        >
          <span class="sr-only">Loading...</span>
        ...
        <div
          class="animate-spin inline-block size-6 border-[3px] border-current border-t-transparent text-yellow-600 rounded-full"
          role="status"
          aria-label="loading"
        >
          <span class="sr-only">Loading...</span>
        ...
        <div
          class="animate-spin inline-block size-6 border-[3px] border-current border-t-transparent text-green-600 rounded-full"
          role="status"
          aria-label="loading"
        >
          <span class="sr-only">Loading...</span>
        ...
        <div
          class="animate-spin inline-block size-6 border-[3px] border-current border-t-transparent text-indigo-600 rounded-full"
          role="status"
          aria-label="loading"
        >
          <span class="sr-only">Loading...</span>
        ...
        <div
          class="animate-spin inline-block size-6 border-[3px] border-current border-t-transparent text-purple-600 rounded-full"
          role="status"
          aria-label="loading"
        >
          <span class="sr-only">Loading...</span>
        ...
        <div
          class="animate-spin inline-block size-6 border-[3px] border-current border-t-transparent text-pink-600 rounded-full"
          role="status"
          aria-label="loading"
        >
          <span class="sr-only">Loading...</span>
        ...
        <div
          class="animate-spin inline-block size-6 border-[3px] border-current border-t-transparent text-orange-600 rounded-full"
          role="status"
          aria-label="loading"
        >
          <span class="sr-only">Loading...</span>
    ...
    <div class="card p-8 mb-10">
      <div class="mb-4">
        ...
        <p class="text-sm font-regular text-gray-500 dark:text-gray-400">
          Example of a different size Spinner
        </p>
      </div>
      <div class="space-x-4">
        <div
    ...
    <div class="card p-8 mb-10">
      <div class="mb-4">
        ...
        <p class="text-sm font-regular text-gray-500 dark:text-gray-400">
          Example of a centered Spinner
        </p>
      </div>
      <div>
        <div
          class="min-h-60 flex flex-col bg-white border shadow-sm rounded-xl dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70"
        >
          <div
    ...
    <div class="card p-8 mb-10">
      <div class="mb-4">
        ...
        <p class="text-sm font-regular text-gray-500 dark:text-gray-400">
          Example of a spinner with button
        </p>
      </div>
      <div>
        <button
